          ...
          {dispensary.isPurchased &&
            ...
            (!dispensary.accessoriesMerch || dispensary.accessoriesMerch.trim() === '') && (
              <span className="text-gray-500 text-xs whitespace-nowrap flex items-center gap-1">
                Add Weekly Promotions or Accessories & Merch
                <svg xmlns="http://www.w3.org/2000/svg" className="h-3.5 w-3.5 animate-bounce-x" fill="none" viewBox="0 0 24 24" stroke="currentColor">
